import { handleDelete } from "Admin/src/components/notification"; // Ensure this is the correct path
...
const DeleteArtist = ({ onClose, artistToDelete, onDeleteSuccess }) => {
  const handleConfirmDelete = async () => {
    try {
      ...
      handleDelete();
      onDeleteSuccess(); // Call the callback function provided by the parent component
      onClose(); // Close the modal after successful deletion
    } catch (error) {
      console.error("Xóa artist không thành công:", error);
    }
  };

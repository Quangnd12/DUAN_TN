...
import { selectGenres } from "../../../../redux/slice/artistSongSlice";
...
const UpdateTrack = ({ open, onClose, onUpdateSuccess, songData }) => {
  ...
  const {
    ...
    defaultValues: {
      ...
      releaseDate: songData?.releaseDate
        ? new Date(songData.releaseDate).toISOString().split("T")[0]
        : "",
  ...
  useEffect(() => {
    if (songData) {
      console.log("Current song data:", songData);
      ...
      if (songData.genreIDs && Array.isArray(songData.genreIDs)) {
        console.log("Setting genre IDs:", songData.genreIDs);
        setValue("genreID", songData.genreIDs);
      }
    ...
    >
      <Box
        sx={{
          ...
          position: "relative",
          background:
            "linear-gradient(to bottom right, rgba(26,26,46,0.95), rgba(22,33,62,0.95))",
          borderRadius: "16px",
              ...
              <Controller
                ...
                render={({ field }) => (
                  <FormControl fullWidth error={!!errors.genreID}>
                        ...
                        <Box sx={{ display: "flex", flexWrap: "wrap", gap: 0.5 }}>
                          {selected.map((value) => {
                            ...
                            return (
                              <Chip
                                key={value}
                                label={genre?.name || songData?.genreNames?.[songData.genreIDs.indexOf(value)] || "Unknown"}
                                sx={{
                    ...
                    {errors.genreID && (
                      <FormHelperText error>{errors.genreID.message}</FormHelperText>
                    )}
                  </FormControl>
                )}
              />
                      ...
                      <label htmlFor="image-upload">
                        ...
                        >
                          {imagePreview ? (
                            ...
                            <>
                              <ImageIcon
                                sx={{ fontSize: 40, mb: 1, color: "#3B82F6" }}
                              />

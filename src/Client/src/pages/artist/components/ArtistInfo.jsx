...
const ArtistInfo = () => {
  ...
  const { id } = useParams();
  const artist = data.artists.find(artist => artist.id === parseInt(id));
  ...
  return (
    <div className="relative w-full h-3/5 flex">
      <div className="w-2/5 h-full artist-bg flex items-center justify-center p-8">
      ...
      <div className="w-3/5 h-full bg-gray-300  overflow-hidden">
        <img
          src={artist.image}

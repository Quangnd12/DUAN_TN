...
const ListSongOfToprank = () => {
  ...
  data.topranks.forEach((toprank) => {
    const foundGenre = toprank.gender.find(
          ...
          <div className="mb-8">
            {genreData.top100 && genreData.top100.length > 0 ? (
              genreData.top100.map((song) => (
                <div
                  key={song.id}
                  className="w-80 bg-black rounded-xl overflow-hidden shadow-2xl border border-purple-500 mb-4"
                >
              ...
              <p className="text-gray-600 text-center">
                Không có bài hát nào cho thể loại này.
              </p>
            )}
          </div>
        </div>
